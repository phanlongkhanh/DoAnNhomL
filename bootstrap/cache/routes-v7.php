...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    array (
      ...
      '/categories/admin/categories/store' => 
      array (
        0 => 
        array (
          0 => 
      ...
      '/categories/category-products/search-selective' => 
      array (
        0 => 
        array (
          0 => 
    ...
    2 => 
    array (
      0 => '{^(?|/a(?|pi/([^/]++)/products(*:32)|ccount/(?|([^/]++)(?|(*:60))|Account/banned/([^/]++)(*:91)))|/homepage/details\\-product/([^/]++)(*:135)|/p(?|ro(?|duct(?|types/(?|([^/]++)(*:177)|add(*:188)|([^/]++)(?|(*:207))|product\\-type/active/([^/]++)(*:245))|/([^/]++)(?|(*:266)))|file(?|/([^/]++)(*:292)|\\-controlelr/(?|update\\-password/([^/]++)(*:341)|([^/]++)(*:357))))|ays/(?|([^/]++)(*:383)|add(*:394)|pays/([^/]++)/update\\-status/([^/]++)(*:439))|ost/(?|([^/]++)(*:463)|edit/([^/]++)(*:484)|update/([^/]++)(*:507)))|/transports/(?|([^/]++)(?|(*:543))|transport/active/([^/]++)(*:577))|/suppliers/([^/]++)(?|(*:608))|/f(?|avorites/([^/]++)(*:639)|orgot/update/([^/]++)(*:668))|/orders/(?|([^/]++)(?|(*:699))|orders/active/([^/]++)(*:730))|/c(?|a(?|rts/([^/]++)(*:760)|tegor(?|ies/(?|edit\\-category/([^/]++)(*:806)|update\\-category/([^/]++)(*:839)|admin/categories/(?|delete/([^/]++)(*:882)|active/([^/]++)(*:905)))|y\\-post/category\\-post/(?|delete/([^/]++)(*:956)|edit/([^/]++)(*:977)|update/([^/]++)(*:1000))))|hat/chat/([^/]++)(*:1029))|/live(?|/([^/]++)(*:1056)|streams/(?|([^/]++)(*:1084)|add(*:1096))))/?$}sDu',
    ),
    3 => 
    array (
      32 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@getNewProducts',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@getNewProducts',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'livestream.products',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      'uri' => 'producttypes/product-type/active/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\TranSportController@AddTranSports',
        'controller' => 'App\\Http\\Controllers\\TranSportController@AddTranSports',
        'namespace' => NULL,
        'prefix' => '/transports',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'transports/transport/active/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'pays/pays/{id}/update-status/{status}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/admin/categories/store',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/edit-category/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/update-category/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/admin/categories/delete/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/admin/categories/active/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/category-products/search',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      'uri' => 'categories/category-products/search-selective',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\AccountController@BannedAccount',
        'controller' => 'App\\Http\\Controllers\\AccountController@BannedAccount',
        'namespace' => NULL,
        'prefix' => '/account',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\PostController@ShowEditPost',
        'controller' => 'App\\Http\\Controllers\\PostController@ShowEditPost',
        'namespace' => NULL,
        'prefix' => '/post',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\CategoryPostController@ShowCreateCategoryPost',
        'controller' => 'App\\Http\\Controllers\\CategoryPostController@ShowCreateCategoryPost',
        'namespace' => NULL,
        'prefix' => '/category-post',
        'where' => 
        array (
    ...
    array (
      ...
      'uri' => 'profile-controlelr/update-password/{id}',
      'action' => 
      array (
        'middleware' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@index',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@index',
        'namespace' => NULL,
        'prefix' => '/live',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@create',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@create',
        'namespace' => NULL,
        'prefix' => '/live',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@store',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@store',
        'namespace' => NULL,
        'prefix' => '/live',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@destroy',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@destroy',
        'namespace' => NULL,
        'prefix' => '/live',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserController@ShowLiveStream',
        'controller' => 'App\\Http\\Controllers\\UserController@ShowLiveStream',
        'namespace' => NULL,
        'prefix' => '/livestreams',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@list',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@list',
        'namespace' => NULL,
        'prefix' => '/livestreams',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@detail',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@detail',
        'namespace' => NULL,
        'prefix' => '/livestreams',
        'where' => 
        array (
        ),
        'as' => 'detail-livestreams',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\LivestreamController@AddToCartLiveStreams',
        'controller' => 'App\\Http\\Controllers\\LivestreamController@AddToCartLiveStreams',
        'namespace' => NULL,
        'prefix' => '/livestreams',
        'where' => 
        array (
