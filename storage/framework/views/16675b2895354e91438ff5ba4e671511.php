    ...
    <section class="content">
        <div class="row">
            <div class="box box-primary">
                <form role="form" action="<?php echo e(route('store-category')); ?>" method="post" enctype="multipart/form-data">
...
<?php echo $__env->make('ControllerAdmin.dashboard_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/Admin/category/create.blade.php ENDPATH**/ ?>