    ...
    <section class="content">
        ...
        <div class="row">
            <div class="box box-primary">
                <form role="form" action="<?php echo e(url('update-account/' . Crypt::encrypt($user->id))); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="box-body">
                        <div class="col-sm-8">
...
<?php echo $__env->make('ControllerAdmin.dashboard_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/Admin/account/edit.blade.php ENDPATH**/ ?>