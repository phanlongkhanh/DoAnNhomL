                    ...
                    <div class="box-body" style="">
                        <div class="table-responsive">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                    <?php if(isset($dataDashboard)): ?>
                                        <?php $__currentLoopData = $dataDashboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($item->id_oder); ?></td>
                                                <td>
                                                    <ul>
                                                        <li>Name: <?php echo e($item->name); ?></li>
                                                        <li>Email: <?php echo e($item->email); ?></li>
                                                        <li>Phone: <?php echo e($item->phone); ?></li>
                                                        <li>Address: <?php echo e($item->district); ?></li>
                                                    </ul>
                                                </td>

                                                <td><?php echo e(number_format($item->intomoney, 0, ',', '.')); ?> VND</td>
                                                <td>
                                                    <?php if($item->status == 'Huỷ'): ?>
                                                ...
                                                <td>
                                                    <span class="label label-warning"
                                                        style="cursor: default; pointer-events: none;">
                                                        <?php echo e($item->payoftype->name); ?>
...
<?php echo $__env->make('ControllerAdmin.dashboard_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/Admin/dashboard/dashboard.blade.php ENDPATH**/ ?>