                            ...
                            <div class="col-sm-8">
                                <div class="form-group <?php echo e($errors->first('category_name') ? 'has-error' : ''); ?>">
                                    ...
                                    <input type="text" class="form-control" name="category_name"
                                        value="<?php echo e($category->name); ?>" placeholder="Name ......" required>
                                ...
                                <div class="form-group <?php echo e($errors->first('category_description') ? 'has-error' : ''); ?>">
                                    ...
                                    <textarea class="form-control" name="category_description" rows="3" placeholder="Enter ..." required><?php echo e($category->description); ?></textarea>
...
<?php echo $__env->make('ControllerAdmin.dashboard_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/Admin/category/update.blade.php ENDPATH**/ ?>