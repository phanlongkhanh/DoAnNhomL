...
<body>
    ...
    <div class="container my-5">
                        ...
                        <a href="<?php echo e(url('details-product', ['id' => Crypt::encrypt($item->id_product)])); ?>">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo e(url('favorite-delete', $item->id)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
        ...
        <div class="pagination justify-content-center mt-4">
            <?php echo e($favorites->links('pagination::bootstrap-4')); ?>
...
<?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/User/favorite/index.blade.php ENDPATH**/ ?>