...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/responsive1.css')); ?>">
...
<body>
                        ...
                        <div class="col-md-4 mb-4">
                            <a href="<?php echo e(url('details-product', ['id' => Crypt::encrypt($item->id_product)])); ?>">
                                ...
                                <div class="card shadow">
                                    <img src="<?php echo e(asset('images/' . $item->image)); ?>" width="300px" height="300px"
                                        class="card-img-top" alt="Sản Phẩm 1">
                                    <div class="card-body text-center">
                                        <h5 class="card-title"><?php echo e($item->name); ?></h5>
                                        <p class="card-text">Giá: <?php echo e(number_format($item->price, 0, ',', '.')); ?> VNĐ</p>
    ...
    <script>
        function searchProducts() {
            ...
            window.location.href = `<?php echo e(route('category-products.search')); ?>?query=` + encodeURIComponent(query) + `&category=all`;
        }
    ...
    <script>
        function filterProducts(category) {
            ...
            window.location.href = `<?php echo e(route('category-products.search-selective')); ?>?query=` + encodeURIComponent(query) +
...
<?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/User/category/index.blade.php ENDPATH**/ ?>