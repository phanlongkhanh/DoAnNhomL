            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <div class="box-tools">
                            <form action="<?php echo e(route('searchcategory')); ?>" method="GET" class="form-inline" style="display: inline;">
                                <div class="input-group input-group-sm" style="width: 150px;">
                                    <input type="text" name="search" class="form-control pull-right ajax-search-table" placeholder="Tìm kiếm theo ID hoặc là tên danh mục" value="<?php echo e(request('search')); ?>">
                                ...
                                <?php if(isset($categories)): ?>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo e(asset('images/' . $item->image)); ?>" alt="" width="200px" height="150px"></td>
                                            ...
                                            <td><?php echo e($item->user ? $item->user->name : 'N/A'); ?></td>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?php echo e(route('editcategory', ['id' => encrypt($item->id)])); ?>"
...
<?php echo $__env->make('ControllerAdmin.dashboard_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/Admin/category/index.blade.php ENDPATH**/ ?>