...
<head>
    ...
    <!-- bootstrap core css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/bootstrap1.css')); ?>" />

    <!-- Custom styles for this template -->
    <link href="<?php echo e(asset('css/style1.css')); ?>" rel="stylesheet" />

    <!-- responsive style -->
    <link href="<?php echo e(asset('css/responsive1.css')); ?>" rel="stylesheet" />
...
<body>
            ...
            <nav class="navbar navbar-expand-lg custom_nav-container ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav  ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo e('category-user-product'); ?>">
                                Danh Mục
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="user_option">
                        ...
                        <div class="d-flex">
                            <a href="<?php echo e('cart-user-product'); ?>" class="btn btn-outline-danger me-2"><i
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-sm-6 col-md-4 col-lg-3">
                            <div class="product-box">
                                <a href="<?php echo e(url('details-product', ['id' => Crypt::encrypt($item->id_product)])); ?>">
                                    <div class="img-box"
                                        style="border:2px solid black; width: 100%; height: 350px; overflow: hidden; position: relative;">
                                        <img src="images/<?php echo e($item->image); ?>" alt="Product Image"
                                        ...
                                        <div class="product-info"
                                            ...
                                            <h6 style="margin: 0; font-weight: bold;">
                                                <span
                                                    style="color: rgb(246, 4, 4); font-size: 20px;"><?php echo e($item->name); ?></span>
                                            </h6>
                                            <h6 style="margin: 0; font-weight: bold;">
                                                Giá
                                                <span
                                                    style="color: green; font-size: 20px;"><?php echo e(number_format($item->price, 0, ',', '.')); ?>
                                            ...
                                            <div class="detail-box">
                                                ...
                                                <form action="<?php echo e(url('favorite-add')); ?>" method="post"
                                                    style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="id_product"
    ...
    <script src="<?php echo e(asset('css/jquery-3.4.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('css/bootstrap1.js')); ?>"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/OwlCarousel2/2.3.4/owl.carousel.min.js"></script>
    <script src="<?php echo e(asset('css/custom.js')); ?>"></script>
...
<?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/User/crud_user/homepage.blade.php ENDPATH**/ ?>