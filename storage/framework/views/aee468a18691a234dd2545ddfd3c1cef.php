...
<?php endif; ?>
    ...
    <div class="container my-5">
            ...
            <tbody>
                <?php if(isset($carts)): ?>
                    <?php $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>
                                <img src="<?php echo e(asset('images/' . $item->image)); ?>" style="height: 200px"
                                    alt="Tên Sản Phẩm" class="img-fluid">
                            </td>
                            <td class="text-danger h5"><?php echo e($item->name); ?></td>
                            <td class="price"><?php echo e(number_format($item->price, 0, ',', '.')); ?> VNĐ</td>
                            <td>
                                <div class="d-flex align-items-center justify-content-center">
                                    <button class="btn btn-outline-danger btn-sm"
                                        onclick="updateQuantity(this, -1)">-</button>
                                    <span class="mx-2 quantity"><?php echo e($item->amount); ?></span>
                                    <button class="btn btn-outline-success btn-sm"
                                        onclick="updateQuantity(this, 1)">+</button>
                                </div>
                            </td>
                            <td class="total-price"><?php echo e(number_format($item->total_price, 0, ',', '.')); ?> VNĐ</td>
                            <td>
                                <form action="<?php echo e(route('carts-remove', $item->id)); ?>" method="POST"
        ...
        <div class="text-center">
            <h5 class="me-3">Tổng Tiền: <span id="totalPrice"><?php echo e(number_format($tong, 0, ',', '.')); ?> VNĐ</span></h5>
            <?php if(isset($carts) && count($carts) > 0): ?>
                <a href="<?php echo e(url('pay-edit', ['id' => Crypt::encrypt($carts[0]->id)])); ?>">
...
<?php /**PATH D:\doan\DoAnNhomL_test6\resources\views/User/cart/index.blade.php ENDPATH**/ ?>