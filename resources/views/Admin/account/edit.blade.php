...
<section class="content">
    <div class="row">
        <div class="box box-primary">
            <form role="form" action="{{ url('update-account/' . $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="box-body">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('role_id') ? 'has-error' : '' }}">
                            ...
                            <input type="number" class="form-control" name="role_id" value="{{ $user->role_id }}" required>
